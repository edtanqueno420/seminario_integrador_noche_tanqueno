...
export default function CP_FormularioAccesoPlanta() {
  ...
  return (
    ...
    >
      <input
        ...
        placeholder="Correo del operario"
      ...
      <button
        ...
        style={{
          padding: '10px',
          background: state.isLoading ? '#93c5fd' : '#27ae60',
          color: '#fff', border: 'none', borderRadius: 6,
          cursor: state.isLoading ? 'not-allowed' : 'pointer',
          fontWeight: 500,
        }}
      >
        {state.isLoading ? 'Accediendo...' : 'Acceder a Planta'}
      </button>
