...
export function CP_AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  async function login(email: string, _password: string) {
    ...
    dispatch({
      type: 'LOGIN_SUCCESS',
      user: { id: 1, name: 'Carlos Mendoza', email, role: 'supervisor' },
    })
  }
...
export function useAuth(): AuthContextValue {
  ...
  if (!context) throw new Error('useAuth debe usarse dentro de <CP_AuthProvider>')
  return context
}
