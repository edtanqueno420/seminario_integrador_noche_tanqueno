...
export default function CP_GestorTareasProduccion() {
  ...
  return (
    <div style={{ maxWidth: 380 }}>
      <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
        ...
        <button
          onClick={addTask}
          style={{ padding: '8px 16px', background: '#27ae60', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer' }}
        >
          Agregar
        </button>
      </div>
      ...
      {tasks.length === 0 && (
        <p style={{ color: '#999', fontSize: 14 }}>No hay tareas de producción. ¡Agrega una!</p>
      )}
