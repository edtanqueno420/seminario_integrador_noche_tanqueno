...
const mp_TaskManager: React.FC = () => {
  const [tasks, setTasks] = useState<Task[]>([
    { id: 1, text: "Revisar soldadura de pieza #12", completed: false, priority: "alta" },
    { id: 2, text: "Calibrar maquina #05", completed: true, priority: "media" },
    { id: 3, text: "Inspeccionar lote #08", completed: false, priority: "baja" },
  ]);
  ...
  return (
    <div style={{ padding: "20px", border: "2px solid #333", borderRadius: "10px", maxWidth: "500px" }}>
      <h2>Gestion de Tareas de Produccion</h2>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "16px" }}>
        <input
          ...
          placeholder="Nueva tarea de produccion..."
